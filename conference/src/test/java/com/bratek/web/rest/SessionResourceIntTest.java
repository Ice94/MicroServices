...
import com.bratek.ConferenceApp;

import com.bratek.domain.Session;
import com.bratek.repository.SessionRepository;
import com.bratek.web.rest.errors.ExceptionTranslator;
...
import static com.bratek.web.rest.TestUtil.sameInstant;
import static com.bratek.web.rest.TestUtil.createFormattingConversionService;
...
public class SessionResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_END_DATA_TIME = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_END_DATA_TIME = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public static Session createEntity(EntityManager em) {
        Session session = new Session()
            ...
            .endDataTime(DEFAULT_END_DATA_TIME);
        return session;
    }
    ...
    public void createSession() throws Exception {
        ...
        assertThat(testSession.getDescriptionContentType()).isEqualTo(DEFAULT_DESCRIPTION_CONTENT_TYPE);
        assertThat(testSession.getStartDateTime()).isEqualTo(DEFAULT_START_DATE_TIME);
        assertThat(testSession.getEndDataTime()).isEqualTo(DEFAULT_END_DATA_TIME);
    }
    ...
    @Test
    @Transactional
    public void checkEndDataTimeIsRequired() throws Exception {
        int databaseSizeBeforeTest = sessionRepository.findAll().size();
        // set the field null
        session.setEndDataTime(null);
    ...
    public void getAllSessions() throws Exception {
        ...
        restSessionMockMvc.perform(get("/api/sessions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].endDataTime").value(hasItem(sameInstant(DEFAULT_END_DATA_TIME))));
    }
    ...
    public void getSession() throws Exception {
        ...
        restSessionMockMvc.perform(get("/api/sessions/{id}", session.getId()))
            ...
            .andExpect(jsonPath("$.endDataTime").value(sameInstant(DEFAULT_END_DATA_TIME)));
    }
    ...
    public void updateSession() throws Exception {
        ...
        updatedSession
            ...
            .endDataTime(UPDATED_END_DATA_TIME);
        ...
        assertThat(testSession.getDescriptionContentType()).isEqualTo(UPDATED_DESCRIPTION_CONTENT_TYPE);
        assertThat(testSession.getStartDateTime()).isEqualTo(UPDATED_START_DATE_TIME);
        assertThat(testSession.getEndDataTime()).isEqualTo(UPDATED_END_DATA_TIME);
    }
